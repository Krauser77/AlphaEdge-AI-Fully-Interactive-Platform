...
import { Zap, Mail, Lock, Eye, EyeOff, Loader2, ArrowRight, TrendingUp, Shield, Brain } from 'lucide-react';
...
export default function Login() {
  ...
  const features = [
    { icon: <TrendingUp size={20} />, title: 'AI-Powered Analysis', desc: 'Real-time market insights' },
    { icon: <Shield size={20} />, title: 'Risk Management', desc: 'Advanced portfolio protection' },
    { icon: <Brain size={20} />, title: 'Multi-Agent AI', desc: '10 autonomous research agents' },
  ];

  return (
    <div className="min-h-screen bg-[#070a12] flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-500/10 via-cyan-500/5 to-purple-500/10 p-12 flex-col justify-between relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">AlphaEdge</h1>
              <p className="text-xs text-emerald-400 font-semibold tracking-widest uppercase">AI Research Platform</p>
            </div>
          </div>
          
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Autonomous Stock & Crypto<br />
            <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Research Intelligence</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-md">
            Harness the power of multi-agent AI systems for institutional-grade market analysis and autonomous trading insights.
          </p>
        </div>
        
        <div className="relative z-10 space-y-4">
          {features.map((feature, i) => (
            <div key={i} className="flex items-center gap-4 bg-white/5 backdrop-blur rounded-xl p-4 border border-white/10">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#0d1117] border border-gray-800/60 rounded-2xl p-8">
            ...
            <p className="text-gray-400 text-sm mb-8">Sign in to access your research dashboard</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-600 bg-white/5 text-emerald-500 focus:ring-emerald-500/20" />
          ...
          <div className="mt-4 p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl">
            <p className="text-xs text-emerald-400 text-center">
              <strong>Demo:</strong> Enter any email and password (6+ chars) to sign in
            </p>
          </div>
        </div>
      </div>
